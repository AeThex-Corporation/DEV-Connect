...
export const WhyJoinSection = () => {
  return (
    <section className="px-6 py-20">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold mb-12">Why Join Devconnect?</h2>
