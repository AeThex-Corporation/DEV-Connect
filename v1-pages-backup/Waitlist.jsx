...
export default function Waitlist() {
  ...
  const handleReferralShare = async (platform) => {
    ...
    if (platform === 'copy') {
      ...
      window.open(`https://twitter.com/intent/tweet?text=Join me on Dev-Link - the future of Roblox development!&url=${encodeURIComponent(referralUrl)}`, '_blank');
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6">
          <div className="flex justify-between items-center h-16 sm:h-16">
            <div className="flex items-center space-x-2">
              <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68d9d1f385dfdd1e5c5c92d0/c5979f609_Gemini_Generated_Image_q227rdq227rdq2271.png" alt="Dev-Link Logo" style={{ width: '32px', height: '32px', objectFit: 'contain' }} className="sm:w-10 sm:h-10" />
              <span className="text-white font-bold text-lg sm:text-xl">Dev-Link</span>
          ...
          <TabsContent value="faq" className="space-y-12">
            <section>
              ...
              <div className="space-y-3 max-w-3xl mx-auto">
                {[
                  { q: "When will Dev-Link launch?", a: "We're targeting Q1 2026 for beta access to waitlist members." },
                  { q: "Is Dev-Link free to use?", a: "Yes! The core platform is free for both developers and employers." },
                  { q: "What makes Dev-Link different?", a: "We're laser-focused on Roblox development jobs with a clean, simple interface." },
