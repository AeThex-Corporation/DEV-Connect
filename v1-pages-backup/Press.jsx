      ...
      <section className="py-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            {/* Company Info */}
            <div>
              <h2 className="text-2xl font-bold text-white mb-6">About Dev-Link</h2>
              <Card className="glass-card border-0 p-8">
                <h3 className="text-white font-semibold mb-3">Company Overview</h3>
                <p className="text-gray-400 text-sm leading-relaxed mb-6">
                  Dev-Link is a new platform launching in 2025 to connect Roblox developers with studios and opportunities. 
