  ...
  const sendAIMessage = async () => {
    ...
    try {
      const response = await base44.integrations.Core.InvokeLLM({
        prompt: `You are Dev-Link AI Assistant, a helpful chatbot for a Roblox developer job platform. Help users with questions about the platform, career advice, job searching, portfolio tips, and Roblox development.
                ...
                <div className="p-4 border-b border-white/10 bg-gradient-to-r from-purple-500/10 to-indigo-500/10">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Ask me anything about Dev-Link, careers, or Roblox development
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="text-center py-12">
                      ...
                      <div className="grid grid-cols-2 gap-2 max-w-md mx-auto">
                        <div className="glass-card rounded-lg p-3 text-left">
                          ...
                          <p className="text-gray-400 text-xs">How to use Dev-Link</p>
                        </div>
                        <div className="glass-card rounded-lg p-3 text-left">
